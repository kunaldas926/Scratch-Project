...
import com.application.app.databinding.RowExplore2Binding
...
public class RecyclerViewAdapter(
...
) : RecyclerView.Adapter<RecyclerViewAdapter.RowExplore2VH>() {
  ...
  public override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RowExplore2VH {
    val view=LayoutInflater.from(parent.context).inflate(R.layout.row_explore_2,parent,false)
